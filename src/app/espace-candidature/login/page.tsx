...
export default function LoginPage() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    window.location.href = '/espace-candidature';
  };
    ...
    <div className="min-h-screen bg-navy flex items-center justify-center px-4">
      <div className="w-full max-w-sm">
          ...
          <div className="space-y-5">
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 rounded-xl border border-gray-200 text-sm focus:outline-none focus:ring-2 focus:ring-teal/50 focus:border-teal"
              />
            </div>
        ...
        <p className="text-center text-gray-500 text-xs mt-6">
          Acces reserve au personnel Linova Education
        </p>
      </div>
    </div>
  );
