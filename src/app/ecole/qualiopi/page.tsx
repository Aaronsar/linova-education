            ...
            <div className="space-y-4">
              {[
                ...
                },
                {
                  ...
                  description: "En formation initiale, le cout est de 4 500 euros par an (dont 500 euros de frais d'inscription). Des facilites de paiement sont proposees.",
                  highlight: '4 500 euros/an en initial',
                },
              ].map((item, i) => (
